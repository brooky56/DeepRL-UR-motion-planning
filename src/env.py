...
class CoppeliaSimEnvWrapper(EnvironmentSpec):
    def __init__(self, visualize=True,
        ...
        # Scene selection
        scene_file_path = os.path.join(os.getcwd(), 'simulation/experiment_1_picking_cube.ttt')
        ...
        self.vision_sensor = objects.vision_sensor.VisionSensor("SideCamera")
        self.gripper = objects.dummy.Dummy("UR5_0")
